...
import SubItem from "@/EntityComponents/Order/Items/Item/SubItems/SubItem.vue";
</script>
...
export default {
	...
	inject: ['item', 'itemIndex', 'order', 'updatePricing'],

	methods: {
		addSubItem(){
			this.item.subitems.push( entity.order.item.subitem.create() );
			this.updatePricing();
		},
		removeSubItem(index) {
