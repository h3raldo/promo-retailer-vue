			...
			<div class="d-flex gap-3 align-items-center">
				...
				<div>
					<div class="form-floating">
						<select class="form-select" id="status" v-model="quote.info.status">
				...
				<div class="col-5">
					<div class="form-floating">
						<input type="text" class="form-control" id="client" placeholder="Quote Name" v-model="quote.info.title">
					...
					<Modal :id="'quote-info-edit'" :title="'Quote Info'" :buttonText="''" :buttonClasses="'btn btn-primary'" :icon="'bi-pencil'">
						<div class="d-flex flex-column gap-3">
							<div class="d-flex gap-4 align-items-center">
								...
								<div>
									<select class="form-select" id="status" v-model="quote.info.category">
							...
							<div class="d-flex gap-4 align-items-center">
								...
								<div class="col-2">
									<input type="date" class="form-control" placeholder="Date" v-model="quote.info.date" >
								</div>
							</div>
							<div class="d-flex gap-4 align-items-center">
								<label class="col-2 text-end">In-Hands Date:</label>
								<div class="col-2">
									<input type="date" class="form-control" placeholder="In Hands Date" v-model="quote.info.deliver_by">
								</div>
								<div>
									<label>Is Firm?</label>
								</div>
								<div class="col-2">
									<select class="form-select" id="status" v-model="quote.info.deliver_by_strict">
							...
							<div class="d-flex gap-4">
								...
								<input class="form-control" type="text" v-model="quote.client.name" />
							</div>
							<div class="d-flex gap-4">
								<label class="form-label col-2 text-end pt-2">Client Email:</label>
								<input class="form-control" type="text" v-model="quote.client.email" />
							</div>
							<div class="d-flex gap-4">
								<label class="form-label col-2 text-end pt-2">Client Info:</label>
								<textarea class="form-control" v-model="quote.client.info"></textarea>
							</div>
							<div class="d-flex gap-4">
								<label class="form-label col-2 text-end pt-2">Ship To:</label>
								<textarea class="form-control" v-model="quote.client.ship_to"></textarea>
							</div>
							<div class="d-flex gap-4">
								<label class="form-label col-2 text-end pt-2">Order Notes (Public):</label>
								<textarea class="form-control" v-model="quote.info.notes.public"></textarea>
							</div>
							<div class="d-flex gap-4">
								<label class="form-label col-2 text-end pt-2">Order Notes (Private):</label>
								<textarea class="form-control" v-model="quote.info.notes.private"></textarea>
							</div>
						</div>
					</Modal>
				</div>
